...
class BasePolicyGradient:
    ...
    def __init__(self, agent_adversary, env, policy_class, obs_shape, num_actions,num_actions_branch,device,timesteps_per_batch,
                 ...
                 swap_step,team_change,prob_select_latest_model):

         # Initialize actor and critic networks
        self.actor = policy_class(obs_shape, num_actions*num_actions_branch)
        ...
        self.env = default_registry[env].make(seed=seed, worker_id=4, side_channels=[channel], no_graphics=False)
        self.env.reset()
