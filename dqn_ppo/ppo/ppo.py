...
class PPO(BasePolicyGradient):
    ...
    def __init__(self, agent_adversary,env, policy_class, obs_shape, num_actions,num_actions_branch,device,timesteps_per_batch,
                 max_timesteps_per_episode,n_updates_per_iteration,lr,gamma,clip,seed):

        super().__init__(env, agent_adversary, policy_class, obs_shape, num_actions,num_actions_branch,device,timesteps_per_batch,
                 max_timesteps_per_episode,n_updates_per_iteration,lr,gamma,clip,seed)
        self.critic = policy_class(obs_shape, 1)
